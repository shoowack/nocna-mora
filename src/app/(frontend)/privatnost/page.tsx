    ...
    <div className="mx-auto max-w-3xl px-4 py-8">
      ...
      <div className="space-y-6 text-muted-foreground">
        ...
        <section>
          ...
          <p>
            Videi su ugrađeni s vanjskih platformi (YouTube, Vimeo, itd.).
            Te platforme mogu koristiti vlastite kolačiće i pratiti aktivnost.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Za pitanja o privatnosti, kontaktirajte nas putem email adrese navedene u podnožju stranice.
          </p>
        </section>
      </div>
    </div>
