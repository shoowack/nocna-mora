  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-24 text-center">
      ...
      <p className="mx-auto mb-8 max-w-md text-muted-foreground">
        Nažalost, kategorija koju tražite nije dostupna. Moguće je da je
        uklonjena ili da je došlo do greške u vezi. Molimo vas da provjerite URL
        ili pretražite kategorije klikom na gumb ispod.
      </p>
      <Link
        href="/kategorije"
