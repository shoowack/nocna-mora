      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "border-stone-200 flex w-full p-1 shadow-sm rounded-md border min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit",
              className
            )}
          >
            {selectedValues.length > 0 ? (
              <div className="flex w-full items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  <XIcon
                    className="mx-2 h-4 cursor-pointer text-stone-500"
                    onClick={(event) => {
                      event.stopPropagation();
                      handleClear();
                    }}
                  ...
                  />
                  <ChevronDown className="mx-2 h-4 cursor-pointer text-stone-500" />
                </div>
              </div>
            ) : (
              <div className="mx-auto flex w-full items-center justify-between">
                <span className="mx-3 text-sm text-stone-500">
                  {placeholder}
                </span>
                <ChevronDown className="mx-2 h-4 cursor-pointer text-stone-500" />
              </div>
